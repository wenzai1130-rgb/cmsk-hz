...
export const CITY_DIST_ALL: CityDistRow[] = [
  { name: "上海公司", group: "东部城市群组", 综合型大盘: 88.5, 正常持销: 22.4, 公商办: 18.6, 滞销项目: 14.5, 车位尾盘: 6.2, 未分类: 4.8, total: 155.0, period: 18.5 },
  { name: "深圳公司", group: "南部城市群组", 综合型大盘: 76.4, 正常持销: 20.1, 公商办: 16.4, 滞销项目: 12.8, 车位尾盘: 5.6, 未分类: 4.2, total: 135.5, period: 19.8 },
  { name: "北京公司", group: "北部城市群组", 综合型大盘: 64.2, 正常持销: 17.5, 公商办: 14.2, 滞销项目: 10.4, 车位尾盘: 4.8, 未分类: 3.6, total: 114.7, period: 22.4 },
  { name: "广州公司", group: "南部城市群组", 综合型大盘: 52.3, 正常持销: 14.6, 公商办: 11.5, 滞销项目: 8.6, 车位尾盘: 3.8, 未分类: 3.0, total: 93.8, period: 24.6 },
  { name: "天津公司", group: "北部城市群组", 综合型大盘: 38.1, 正常持销: 10.8, 公商办: 8.4, 滞销项目: 6.2, 车位尾盘: 2.6, 未分类: 2.2, total: 68.3, period: 26.8 },
  { name: "杭州公司", group: "东部城市群组", 综合型大盘: 33.8, 正常持销: 10.1, 公商办: 7.2, 滞销项目: 4.8, 车位尾盘: 2.5, 未分类: 1.9, total: 60.3, period: 17.2 },
  { name: "南京公司", group: "东部城市群组", 综合型大盘: 31.5, 正常持销: 9.4, 公商办: 6.8, 滞销项目: 4.4, 车位尾盘: 2.5, 未分类: 1.8, total: 56.4, period: 15.8 },
  { name: "成都公司", group: "西部城市群组", 综合型大盘: 28.3, 正常持销: 8.6, 公商办: 6.1, 滞销项目: 4.0, 车位尾盘: 2.3, 未分类: 1.6, total: 50.9, period: 20.6 },
  { name: "武汉公司", group: "中部城市群组", 综合型大盘: 26.9, 正常持销: 8.2, 公商办: 5.8, 滞销项目: 3.7, 车位尾盘: 2.2, 未分类: 1.5, total: 48.3, period: 19.4 },
  { name: "厦门公司", group: "东部城市群组", 综合型大盘: 24.5, 正常持销: 7.4, 公商办: 5.2, 滞销项目: 3.4, 车位尾盘: 2.0, 未分类: 1.4, total: 43.9, period: 16.9 },
  { name: "苏州公司", group: "东部城市群组", 综合型大盘: 23.1, 正常持销: 7.0, 公商办: 4.9, 滞销项目: 3.2, 车位尾盘: 1.9, 未分类: 1.3, total: 41.4, period: 16.2 },
  { name: "重庆公司", group: "西部城市群组", 综合型大盘: 21.8, 正常持销: 6.6, 公商办: 4.6, 滞销项目: 3.2, 车位尾盘: 1.8, 未分类: 1.2, total: 39.2, period: 23.5 },
  { name: "西安公司", group: "西部城市群组", 综合型大盘: 20.2, 正常持销: 6.1, 公商办: 4.3, 滞销项目: 2.9, 车位尾盘: 1.7, 未分类: 1.1, total: 36.3, period: 21.8 },
  { name: "青岛公司", group: "北部城市群组", 综合型大盘: 18.8, 正常持销: 5.7, 公商办: 4.0, 滞销项目: 2.7, 车位尾盘: 1.6, 未分类: 1.1, total: 33.9, period: 25.2 },
  { name: "长沙公司", group: "中部城市群组", 综合型大盘: 17.4, 正常持销: 5.3, 公商办: 3.7, 滞销项目: 2.5, 车位尾盘: 1.5, 未分类: 1.0, total: 31.4, period: 18.7 },
  { name: "郑州公司", group: "中部城市群组", 综合型大盘: 16.0, 正常持销: 4.9, 公商办: 3.4, 滞销项目: 2.4, 车位尾盘: 1.4, 未分类: 0.9, total: 29.0, period: 22.0 },
  { name: "宁波公司", group: "东部城市群组", 综合型大盘: 15.0, 正常持销: 4.6, 公商办: 3.2, 滞销项目: 2.2, 车位尾盘: 1.3, 未分类: 0.9, total: 27.2, period: 17.6 },
  { name: "佛山公司", group: "南部城市群组", 综合型大盘: 14.0, 正常持销: 4.2, 公商办: 3.0, 滞销项目: 2.0, 车位尾盘: 1.2, 未分类: 0.8, total: 25.2, period: 20.1 },
  { name: "济南公司", group: "北部城市群组", 综合型大盘: 13.0, 正常持销: 3.9, 公商办: 2.8, 滞销项目: 1.9, 车位尾盘: 1.1, 未分类: 0.8, total: 23.5, period: 24.3 },
  { name: "合肥公司", group: "中部城市群组", 综合型大盘: 12.2, 正常持销: 3.7, 公商办: 2.6, 滞销项目: 1.8, 车位尾盘: 1.0, 未分类: 0.7, total: 22.0, period: 19.0 },
];
...
const GROUPS = ["全部城市群组", "南部城市群组", "北部城市群组", "东部城市群组", "西部城市群组", "中部城市群组"];
...
export function CityDistAllDialog({
  ...
  const [grp, setGrp] = useState("全部城市群组");
  ...
  const groupColLabel = isCompany ? "所属城市公司" : "所属城市群组";
  ...
  useEffect(() => {
    setPage(1);
    setQ("");
    setGrp(level === "group" ? org : "全部城市群组");
  }, [org, level, open]);

  const rows = useMemo(() => {
    let r = sourceData.slice();
    if (showGroupFilter && grp !== "全部城市群组") r = r.filter((x) => x.group === grp);
